...
import { Browsers } from '../Utils/misc/browser-utils.js';
import logger from '../Utils/misc/logger.js';
...
export const DONATE_URL = 'https://saweria.co/zavedyaid'; // Lia@Note 02-02-26 --- Apologies if this feels cheeky, just a fallback
