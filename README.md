...
**@zavedyaid/baileys v1.1.0** is a restructured, ZavedyaID-branded build on top of the `itsliaaa/baileys` enhanced fork (interactive messages, albums, additional message types, newsletter media fixes), which itself builds on the original **[WhiskeySockets/Baileys](https://github.com/WhiskeySockets/Baileys)**.
...
3. **ZavedyaID** — folder restructuring (see [`STRUCTURE.md`](STRUCTURE.md)), packaging, and this v1.1.0 rebrand.
